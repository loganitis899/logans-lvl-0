...
public class AnimalFarm {
	...
	for(int i=0; i < 1000; i++){
		...
		String ans = JOptionPane.showInputDialog("what animal do you want to hear? dog, duck, cow, cat, or llama?");
	
		if(ans.equals("dog")){
			playWoof();
		} else if(ans.equals("duck")){
			playQuack();
		} else if(ans.equals("cat")){
			playMeow();
		} else if(ans.equals("cow")){
			playMoo();
		} else { 
			playLlama();
		}
